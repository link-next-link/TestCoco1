...
void MainLayer::createLabel( const char* msg ) {
    ...
    label1->setPosition( _screenSize.width*0.5f, _screenSize.height*0.6f );
...
void MainLayer::createLabelSys( const char* msg, int fontSize) {
    auto labelA = Label::createWithSystemFont( msg, "Arial.ttf", fontSize);
